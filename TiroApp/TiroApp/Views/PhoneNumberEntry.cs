...
namespace TiroApp.Views
{
    public class PhoneNumberEntry : StackLayout
    {
        ...
        public string PhoneNumber
        {
            get
            {
                return selectedCode + entry.Text;
            }
        }

        public CustomEntry NumberEntry
        {
            get
            {
                return entry;
        ...
        private void InitPhoneCodes()
        {
            ...
            foreach (JObject cn in codes)
            {
                phoneCodes.Add(new PhoneCode((string)cn["name"], (string)cn["code"]));
            }
        }
        ...
        private void Picker_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                selectedCode = phoneCodes[picker.SelectedIndex].Code;
            }
        }
    }
    ...
    {
        public PhoneCode(string country, string code)
        {
            Country = country;
            Code = code;
        }
