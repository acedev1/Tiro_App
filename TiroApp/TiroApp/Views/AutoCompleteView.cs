...
namespace XLabs.Forms.Controls
{
    ...
    public class AutoCompleteView : ContentView
    {
        ...
        private readonly CustomEntry _entText;
        ...
        public AutoCompleteView()
        {
            ...
            _stkBase.BackgroundColor = Color.White;
            var innerLayout = new StackLayout();
            _entText = new CustomEntry
            {
        ...
        public void Clear()
        {
            _entText.Text = string.Empty;
        }

        public CustomEntry EntryText
        {
            get
            {
                return _entText;
            ...
            try
            {
                ...
                if (control != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(cleanedNewPlaceHolderValue) && control.Suggestions != null)
                    {
                        ...
                        var filteredSuggestions = control.Suggestions.Cast<object>().ToList();
        ...
        public void RaiseTextValueChanged()
        {
            TextValueChanged(this, Placeholder, this.Text);
        }
