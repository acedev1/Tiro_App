[assembly: Xamarin.Forms.Dependency (typeof (XLabs.Platform.Services.Email.EmailService))]
namespace XLabs.Platform.Services.Email
{
	...
	public class EmailService : IEmailService
	{
		...
		{            
            ShowDraft(subject, body, html, new[] { to != null ? to : string.Empty }, new string[] { }, new string[] { }, attachments);
		}
