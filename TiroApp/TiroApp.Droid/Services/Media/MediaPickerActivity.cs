...
namespace XLabs.Platform.Services.Media
{
		...
		: Activity
	{
        ...
        internal const string MaxPixelDimension = "MaxPixelDimension";
        internal const string PercentQuality = "PercentQuality";
		#endregion Constants
        ...
        private int _maxPixelDimension = -1;
        private int _percentQuality = 100;
		...
		protected override void OnCreate(Bundle savedInstanceState)
		{
            ...
            _maxPixelDimension = b.GetInt(MaxPixelDimension, _maxPixelDimension);
            _percentQuality = b.GetInt(PercentQuality, _percentQuality);
		...
		protected override void OnActivityResult(int requestCode, Result resultCode, Intent data)
		{
			...
			if (_tasked)
			{
                ...
                future.ContinueWith((Task<MediaPickedEventArgs> t) =>
                    {
                        if (_maxPixelDimension != -1)
                        {                            
                            global::Services.FileSaveLoad.ResizeAndCompressImage(t.Result.Media.Path, _maxPixelDimension, _percentQuality)
                                .ContinueWith((Task<string> t2) =>
                                {
                                    var mediaArgs = t.Result;
                                    mediaArgs.Media = new MediaFile(t2.Result, () =>
                                    {
                                        return File.OpenRead(t2.Result);
                                    });
                                    RaiseOnMediaPicked(mediaArgs);
                                });
                        }
                        else
                        {
        ...
        private void ResizeAndCompress(){
